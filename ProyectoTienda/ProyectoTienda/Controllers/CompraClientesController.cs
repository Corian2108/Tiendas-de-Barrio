...
namespace ProyectoTienda.Controllers
{
    public class CompraClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Detalle,Cantidad,Precio")] CompraCliente compraCliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Detalle,Cantidad,Precio")] CompraCliente compraCliente)
        {
